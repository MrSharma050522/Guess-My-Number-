...
document.querySelector(".check").addEventListener("click", function () {
  ...
  // alert(`You just typed ${document.querySelector(".guess").value}`);

  // prompt(`You just typed ${document.querySelector(".guess").value}`);

  //   document.querySelector(".message").textContent = "Correct Number😂";

  // document.querySelector(".message").textContent = `You just typed ${document.querySelector(".guess").value}`;
